...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label->setGeometry(QRect(220, 80, 141, 41));
        QFont font;
        font.setFamily(QString::fromUtf8("Times New Roman"));
        font.setPointSize(12);
        label->setFont(font);
        clsButton = new QPushButton(centralwidget);
        clsButton->setObjectName(QString::fromUtf8("clsButton"));
        clsButton->setGeometry(QRect(360, 150, 101, 51));
        ...
        QObject::connect(clsButton, SIGNAL(clicked()), MainWindow, SLOT(close()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        clsButton->setText(QCoreApplication::translate("MainWindow", "Close", nullptr));
